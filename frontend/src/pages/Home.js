      ...
      <div className="container-home">
        <div className="chart-container">
          <div className="chart-header">
            <button className="chevron-btn" onClick={handleClickDec}>
              <span className="material-symbols-outlined chevron">chevron_left</span>
            </button>
            <h1>Workouts</h1>
            <button className="chevron-btn" onClick={handleClickInc}>
          ...
          <Chart modifier={modifier} backendUrl={backendUrl} />
        </div>
        <WorkoutsTable backendUrl={backendUrl} />
      </div>
    </>
  );
}
